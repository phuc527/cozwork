...
const ClientReminders: FC<IProps> = ({
    ...
    const [onStateConsultReminderSms, setOnStateConsultReminderSms] =
        useState(false);
    const [onStateConsultReminderEmail, setOnStateConsultReminderEmail] =
        useState(false);

    const [onStateUploadImageReminder, setOnStateUploadImageReminder] =
        useState(false);
    const [onStateUploadImageReminderSms, setOnStateUploadImageReminderSms] =
        useState(false);
    const [
        onStateUploadImageReminderEmail,
        setOnStateUploadImageReminderEmail,
    ] = useState(false);

    useEffect(() => {
        if (bookConsultReminder) {
            const ConsultReminderSMS = bookConsultReminder?.sms
                ? bookConsultReminder?.sms
                : false;
            const ConsultReminderEmail = bookConsultReminder?.email
                ? bookConsultReminder?.email
                : false;
        ...
        if (uploadImageReminder) {
            const UploadImageReminderSMS = uploadImageReminder?.sms
                ? uploadImageReminder?.sms
                : false;
            const UploadImageReminderEmail = uploadImageReminder?.email
                ? uploadImageReminder?.email
                : false;
    ...
    const onSaveToggleConsultReminder = (state: boolean) => {
        setOnStateConsultReminder(!state);
        onChangeNotification(
            SETTING.consult_reminder,
            !onStateConsultReminder,
            onStateConsultReminderEmail,
            onStateConsultReminderSms
        );
    };
    const onSaveToggleUploadImageReminder = (state: boolean) => {
        setOnStateUploadImageReminder(!state);
        onChangeNotification(
            SETTING.upload_image_reminder,
            !onStateUploadImageReminder,
            onStateUploadImageReminderEmail,
            onStateUploadImageReminderSms
        );
    };
    return (
        <>
            ...
            <StyledCard>
                <StyledCardBody>
                    ...
                    <StyledPlanInfo>
                        Send me an email reminders to book a consult after
                    ...
                    <StyledLabelCheck>
                        <StyledLabelCheckBox>
                            ...
                            <Switch
                                state={onStateConsultReminder ? "on" : "off"}
                                onSwitch={(state: boolean) =>
                                    onSaveToggleConsultReminder(state)
                                }
                                width={60}
                                height={30}
                            />
                        ...
                        <StyledLabelCheckBox>
                            <StyledInput
                                type="checkbox"
                                disabled={!onStateConsultReminder}
                                checked={onStateConsultReminderEmail}
                                onChange={(e) => {
                                    onChangeNotification(
                                        SETTING.consult_reminder,
                                        onStateConsultReminder,
                                    ...
                                    setOnStateConsultReminderEmail(
                                        e.target.checked
                                    );
                                }}
                            />
                        ...
                        <StyledLabelCheckBox>
                            <StyledInput
                                type="checkbox"
                                disabled={!onStateConsultReminder}
                                checked={onStateConsultReminderSms}
                                onChange={(e) => {
                                    onChangeNotification(
                                        SETTING.consult_reminder,
                                        onStateConsultReminder,
                    ...
                    <StyledPlanInfo>
                        Send me an email right before I have appointment
                    </StyledPlanInfo>
                    <StyledLabelCheck>
                        <StyledLabelCheckBox>
                            ...
                            <Switch
                                state={
                                    onStateUploadImageReminder ? "on" : "off"
                                }
                                onSwitch={(state: boolean) =>
                                    onSaveToggleUploadImageReminder(state)
                                }
                                width={60}
                                height={30}
                            />
                        ...
                        <StyledLabelCheckBox>
                            <StyledInput
                                type="checkbox"
                                disabled={!onStateUploadImageReminder}
                                checked={onStateUploadImageReminderEmail}
                                onChange={(e) => {
                                    onChangeNotification(
                                        SETTING.upload_image_reminder,
                                        onStateUploadImageReminder,
                        ...
                        <StyledLabelCheckBox>
                            <StyledInput
                                type="checkbox"
                                disabled={!onStateUploadImageReminder}
                                checked={onStateUploadImageReminderSms}
                                onChange={(e) => {
                                    onChangeNotification(
                                        SETTING.upload_image_reminder,
                                        onStateUploadImageReminder,
                                    ...
                                    setOnStateUploadImageReminderSms(
                                        e.target.checked
                                    );
                                }}
                            />
